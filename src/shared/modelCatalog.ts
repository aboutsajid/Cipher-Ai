...
export const NVIDIA_DEFAULT_MODEL = "qwen/qwen3-coder-480b-a35b-instruct";
export const NVIDIA_THINK_MODEL = "deepseek-ai/deepseek-v3.1-terminus";
export const NVIDIA_LONG_CONTEXT_MODEL = "meta/llama-3.1-70b-instruct";
