...
export class AgentTaskRunner {
  ...
  private extractPromptRequirements(prompt: string): PromptRequirement[] {
    ...
    if (supportsVisualRequirements && /\b(summary|summarize|summarizer|summarise)\b/.test(normalized)) {
      addRequirement({
        id: "req-summary",
    ...
    if (supportsVisualRequirements && /\b(login|sign in|auth|authentication|password|account)\b/.test(normalized)) {
      addRequirement({
        id: "req-auth",
