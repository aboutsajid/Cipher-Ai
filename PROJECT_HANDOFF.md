...
- A dedicated Windows desktop regression pack now exists in `prompts/agent-windows-desktop-pack.json` with recurring standalone-software prompts like calculator, notes, invoice desk, file renamer, PDF combiner, expense tracker, and local CRM coverage
